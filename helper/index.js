...
exports.register = function (server, options, next) {
    ...
    require('../endpoints/fantasy_summary.js')(server, options);  
    require('../endpoints/fantasy_squard.js')(server, options);  
    require('../endpoints/player_finder.js')(server, options);  
    next();
};
